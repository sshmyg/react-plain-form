...
/* harmony import */ var _helpers_filterObjectByEmptyValues__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../helpers/filterObjectByEmptyValues */ "./src/helpers/filterObjectByEmptyValues.js");
...
function useErrors() {
  ...
  var customSetErrors = function customSetErrors(currentErrors) {
    return setErrors(function (prevErrors) {
      return Object(_helpers_filterObjectByEmptyValues__WEBPACK_IMPORTED_MODULE_4__["default"])(_babel_runtime_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_1___default()({}, prevErrors, currentErrors));
    });
  };

  var customSetError = function customSetError(name, value) {
    return customSetErrors(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()({}, name, value));
  };
...
function useValidating() {
  ...
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_3__["useState"])(defaultValues),
      _useState2 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_2___default()(_useState, 2),
  ...
  var customSetValidating = Object(react__WEBPACK_IMPORTED_MODULE_3__["useCallback"])(function (name, sate) {
    return setValidating(function (prevState) {
      return _babel_runtime_helpers_objectSpread__WEBPACK_IMPORTED_MODULE_1___default()({}, prevState, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()({}, name, sate));
    });
  }, []);
